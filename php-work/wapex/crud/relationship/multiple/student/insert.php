...
if (isset($_POST["multi_insert"])) {
    ...
    if (empty($studentFirstName) || empty($studentLastName) || empty($studentPhone) || empty($studentEmail) || empty($studentCNIC) || empty($studentPic[0])) {
        ...
        if ($checkExt) {
            ...
            $sql = "INSERT INTO `relationshipmultistudent` (`studentFirstName`, `studentLastName`,`studentTeacher`,`studentClass`, `studentPhone`, `studentEmail`, `studentCNIC`, `studentPic`) VALUES ('$studentFirstName', '$studentLastName','$studentTeacher','$studentClass', '$studentPhone', '$studentEmail', '$studentCNIC', '$studentPicSerial');";
    ...
    <div class="container py-3 bg-primary text-white">
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-8">
                    <select class="form-select" name="studentTeacher" id="studentTeacher">
                        ...
                        ?>
                        <option value="<?php echo $teacher_row["teacherId"] ?>"><?php echo $teacher_row["teacherFirstName"] ?> <?php echo $teacher_row["teacherLastName"] ?></option>
                        <?php
                        }
                        ?>
                    </select>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-8">
                    <input type="file" multiple class="form-control" name="studentPic[]" id="studentPic"
