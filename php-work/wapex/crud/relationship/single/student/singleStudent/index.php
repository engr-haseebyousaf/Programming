                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-borderless table-info align-middle">
                        ...
                        <tbody class="table-group-divider">
                            <?php
                            $sql = "SELECT * FROM `relationshipStudent` rs LEFT JOIN `relationshipTeacher` rt ON rs.`studentTeacher` = rt.`teacherId` LEFT JOIN `class_time` ct ON rs.`studentClass` = ct.`classTimeId`";
