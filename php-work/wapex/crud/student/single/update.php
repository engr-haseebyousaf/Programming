...
include "connect.php";
$id = $_GET["uid"];
$show_sql = "SELECT * FROM `single_student` WHERE `studentId` = '$id';";
...
if (isset($_POST["update"])) {
    ...
    if (!empty($studentFirstName) || !empty($studentLastName) || !empty($studentPhone) || !empty($studentEmail) || !empty($studentCNIC)) {
        if (!empty($_FILES["studentPic"]["name"])) {
            ...
            if (in_array($ext, $allowedExtensions)) {
                ...
                $sql = "UPDATE `single_student` SET `studentFirstName`='$studentFirstName',`studentLastName`='$studentLastName',`studentPhone`='$studentPhone',`studentEmail`='$studentEmail',`studentCNIC`='$studentCNIC',`studentPic`='$studentPicName' WHERE `studentId` = $id;";
            ...
            $sql = "UPDATE `single_student` SET `studentFirstName`='$studentFirstName',`studentLastName`='$studentLastName',`studentPhone`='$studentPhone',`studentEmail`='$studentEmail',`studentCNIC`='$studentCNIC' WHERE `studentId` = $id;";
                if (mysqli_query($conn, $sql)) {
                    $msg = "<div class='alert alert-success'>Updated Successfully</div>";
                    header("Refresh: 1, ./index.php");
                }
    ...
    <div class="container py-3 bg-info">
        <form method="post" enctype="multipart/form-data">
            <div class="mb-3 row">
                ...
                <div class="col-8">
                    <input type="text" class="form-control" value="<?php echo $row["studentFirstName"] ?>" name="studentFirstName" id="studentFirstName" placeholder="studentFirstName" />
                </div>
            </div>
            <div class="mb-3 row">
                <label for="studentLastName" class="col-4 col-form-label"><b>studentLastName</b></label>
                <div class="col-8">
                    <input type="text" class="form-control" value="<?php echo $row["studentLastName"] ?>" name="studentLastName" id="studentLastName" placeholder="studentLastName" />
                </div>
            </div>
            <div class="mb-3 row">
                <label for="studentPhone" class="col-4 col-form-label"><b>studentPhone</b></label>
                <div class="col-8">
                    <input type="text" class="form-control" value="<?php echo $row["studentPhone"] ?>" name="studentPhone" id="studentPhone" placeholder="studentPhone" />
                </div>
            </div>
            <div class="mb-3 row">
                <label for="studentEmail" class="col-4 col-form-label"><b>studentEmail</b></label>
                <div class="col-8">
                    <input type="email" class="form-control" value="<?php echo $row["studentEmail"] ?>" name="studentEmail" id="studentEmail" placeholder="studentEmail" />
                </div>
            </div>
            <div class="mb-3 row">
                <label for="studentCNIC" class="col-4 col-form-label"><b>studentCNIC</b></label>
                <div class="col-8">
                    <input type="text" class="form-control" value="<?php echo $row["studentCNIC"] ?>" name="studentCNIC" id="studentCNIC" placeholder="studentCNIC" />
                </div>
            </div>
            <div class="mb-3 row">
                <label for="studentPic" class="col-4 col-form-label"><b>studentPic</b></label>
                <div class="col-8">
                    <input type="file" class="form-control" name="studentPic" id="studentPic" placeholder="studentPic" />
                </div>
            </div>
