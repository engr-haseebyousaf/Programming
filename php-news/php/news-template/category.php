                ...
                <div class="post-container">
                  ...
                  <?php
                    ...
                    if (mysqli_num_rows($result1)>0) {
                      $total_rows = $row1['post'];
                      $total_pages = ceil($total_rows/$rows_per_page);                      
                      echo "<ul class='pagination admin-pagination'>";
                      if ($page > 1) {
                        echo "<li><a href='category.php?page=".($page-1)."&catid=".$cat_id."'>Prev</a></li>";
                      }
                      for ($i=1; $i <= $total_pages ; $i++) { 
                        ...
                        echo "<li class='$active'><a href='category.php?page=$i&catid=".$cat_id."'>$i</a></li>";
                      }
                      if ($page < $total_pages) {
                        echo "<li><a href='category.php?page=".($page+1)."&catid=".$cat_id."'>Next</a></li>";
                      }
                      echo "</ul>";
                  }
